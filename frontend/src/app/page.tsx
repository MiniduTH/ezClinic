...
const STEPS = [
  {
    ...
    gradient: "linear-gradient(135deg,#e1f5ee,#f0fdf4)",
    accent: "#0f6e56",
  },
  {
...
const SPECIALISTS = [
  { name: "Dr. Chaminda Perera",      specialty: "Cardiology",   rating: "4.9", reviews: "120", bg: "#0f6e56", img: "https://img.freepik.com/free-photo/portrait-mature-therapist-sitting-table-looking-camera_1098-18156.jpg?semt=ais_hybrid&w=740&q=80" },
...
const AVATAR_COLORS = ["#0f6e56","#0369a1","#d97706","#7c3aed","#e11d48"];
  ...
  return (
    <header style={{
      ...
      <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
        ...
        <span style={{ fontFamily: "ui-monospace, monospace", fontSize: "1.2rem", fontWeight: 700 }}>
      ...
      <nav className="landing-nav-links" style={{ display: "flex", alignItems: "center", gap: 4 }}>
        <a href="#how-it-works" style={{ padding: "8px 16px", borderRadius: 8, fontSize: "0.875rem", fontWeight: 500, color: "#475569", textDecoration: "none" }}>How it Works</a>
        <a href="#specialists"  style={{ padding: "8px 16px", borderRadius: 8, fontSize: "0.875rem", fontWeight: 500, color: "#475569", textDecoration: "none" }}>Specialists</a>
        <Link href="/register" style={{ padding: "8px 16px", borderRadius: 8, fontSize: "0.875rem", fontWeight: 500, color: "#0f172a", textDecoration: "none", border: "1px solid #e2e8f0", marginLeft: 8 }}>Sign In</Link>
        <Link href="/register" style={{ padding: "8px 20px", borderRadius: 8, fontSize: "0.875rem", fontWeight: 700, color: "#fff", textDecoration: "none", background: "#0f6e56", marginLeft: 4 }}>Get Started</Link>
      </nav>
    </header>
  );
}
...
function HeroSection() {
  return (
    <section style={{
      ...
      background: "linear-gradient(160deg,#f0fdf4 0%,#e0f2fe 45%,#f8fafc 100%)",
      position: "relative", overflow: "hidden",
    }}>
      {/* Decorative blobs */}
      <div style={{ position:"absolute", top:"-8%",  right:"-4%", width:640, height:640, borderRadius:"50%", background:"radial-gradient(circle,rgba(15,110,86,0.07) 0%,transparent 70%)", pointerEvents:"none" }} />
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <div className="landing-hero-grid">
          ...
          <div className="anim-fade-up">
            {/* Badge */}
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"6px 16px", borderRadius:999, background:"rgba(15,110,86,0.08)", border:"1px solid rgba(15,110,86,0.15)", marginBottom:28 }}>
              <span className="anim-live-dot" style={{ width:8, height:8, borderRadius:"50%", background:"#0f6e56", display:"inline-block" }} />
              <span style={{ fontSize:"0.8125rem", fontWeight:600, color:"#0f6e56" }}>The Digital Sanctuary</span>
            </div>

            <h1 style={{ fontSize:"clamp(2.4rem,5vw,3.8rem)", fontWeight:800, lineHeight:1.08, color:"#0f172a", marginBottom:24, letterSpacing:"-0.025em" }}>
              Compassionate Care,{" "}
              <span style={{ color:"#0f6e56" }}>Digitally Delivered.</span>
            </h1>

            <p style={{ fontSize:"1.1rem", color:"#475569", lineHeight:1.8, maxWidth:520, marginBottom:40 }}>
            ...
            <div className="landing-hero-cta" style={{ display:"flex", gap:12, flexWrap:"wrap", marginBottom:36 }}>
              <Link href="/register"
                style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"14px 32px", borderRadius:12, background:"#0f6e56", color:"#fff", fontSize:"1rem", fontWeight:700, textDecoration:"none", boxShadow:"0 8px 24px rgba(15,110,86,0.28)", transition:"transform 0.2s ease,box-shadow 0.2s ease" }}
                onMouseEnter={e=>{(e.currentTarget as HTMLAnchorElement).style.transform="translateY(-2px)";(e.currentTarget as HTMLAnchorElement).style.boxShadow="0 14px 32px rgba(15,110,86,0.38)";}}
                onMouseLeave={e=>{(e.currentTarget as HTMLAnchorElement).style.transform="";(e.currentTarget as HTMLAnchorElement).style.boxShadow="0 8px 24px rgba(15,110,86,0.28)";}}>
                Get Started Free
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="9 18 15 12 9 6"/></svg>
              </Link>
              <Link href="/register"
                style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"14px 32px", borderRadius:12, background:"white", color:"#0f172a", fontSize:"1rem", fontWeight:600, textDecoration:"none", border:"1px solid #e2e8f0", transition:"background-color 0.2s ease" }}
                onMouseEnter={e=>{(e.currentTarget as HTMLAnchorElement).style.backgroundColor="#f1f5f9";}}
            ...
            <div style={{ display:"flex", alignItems:"center", gap:12 }}>
              ...
              <span style={{ fontSize:"0.875rem", color:"#475569" }}>
                <strong style={{ color:"#0f172a" }}>12,000+</strong> patients trust ezClinic
              </span>
            </div>
          </div>
          ...
          <div className="anim-fade-up anim-d3" style={{ position:"relative" }}>
            <div className="anim-float" style={{ background:"rgba(255,255,255,0.72)", backdropFilter:"blur(20px)", borderRadius:28, border:"1px solid rgba(255,255,255,0.85)", padding:28, boxShadow:"0 28px 72px rgba(0,0,0,0.1)" }}>
              {/* Header */}
              <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
                <div style={{ width:46, height:46, borderRadius:"50%", background:"linear-gradient(135deg,#0f6e56,#1a9478)", display:"flex", alignItems:"center", justifyContent:"center" }}>
                ...
                <div>
                  <div style={{ fontSize:"0.875rem", fontWeight:700, color:"#0f172a" }}>Live Consultation</div>
                  <div style={{ fontSize:"0.75rem", color:"#94a3b8" }}>Dr. Sachini Fernando · General Practice</div>
                </div>
              ...
              {/* Avatar area */}
              <div style={{ height:220, borderRadius:18, overflow:"hidden", marginBottom:16, position:"relative", background:"#e1f5ee" }}>
              ...
              {/* Next slot */}
              <div style={{ padding:"12px 16px", borderRadius:12, background:"rgba(15,110,86,0.06)", border:"1px solid rgba(15,110,86,0.12)" }}>
                <div style={{ fontSize:"0.7rem", color:"#94a3b8", marginBottom:4, fontWeight:500, letterSpacing:"0.03em" }}>NEXT AVAILABLE SLOT</div>
                <div style={{ fontSize:"0.875rem", fontWeight:600, color:"#0f172a" }}>Today, 3:00 PM · 15 min session</div>
              </div>
            </div>

            {/* Floating badge – verified */}
            <div className="anim-scale-in anim-d6" style={{ position:"absolute", top:-18, right:-18, padding:"10px 16px", borderRadius:14, background:"white", boxShadow:"0 8px 28px rgba(0,0,0,0.1)", display:"flex", alignItems:"center", gap:10 }}>
              <div style={{ width:34, height:34, borderRadius:"50%", background:"#e1f5ee", display:"flex", alignItems:"center", justifyContent:"center" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f6e56" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
              </div>
              <div>
                <div style={{ fontSize:"0.75rem", fontWeight:700, color:"#0f172a" }}>Verified Doctors</div>
                <div style={{ fontSize:"0.6875rem", color:"#94a3b8" }}>800+ on platform</div>
              </div>
            </div>

            {/* Floating badge – secure */}
            <div className="anim-scale-in anim-d8" style={{ position:"absolute", bottom:-18, left:-18, padding:"10px 16px", borderRadius:14, background:"white", boxShadow:"0 8px 28px rgba(0,0,0,0.1)", display:"flex", alignItems:"center", gap:10 }}>
              ...
              <div>
                <div style={{ fontSize:"0.75rem", fontWeight:700, color:"#0f172a" }}>End-to-End Encrypted</div>
                <div style={{ fontSize:"0.6875rem", color:"#94a3b8" }}>HIPAA Compliant</div>
              </div>
            </div>
          </div>
        </div>
...
function StatsSection() {
  ...
  return (
    <section ref={ref} style={{ padding:"56px 40px", background:"white", borderTop:"1px solid #e2e8f0", borderBottom:"1px solid #e2e8f0" }}>
      <div style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))", gap:32, textAlign:"center" }}>
        {STATS.map((s, i) => (
          <div key={s.label} style={{ opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(20px)", transition:`opacity 0.55s ease ${i*0.1}s, transform 0.55s ease ${i*0.1}s` }}>
            <div style={{ fontSize:"2.5rem", fontWeight:800, color:"#0f6e56", letterSpacing:"-0.02em", lineHeight:1 }}>{s.value}</div>
            <div style={{ fontSize:"0.875rem", color:"#94a3b8", marginTop:6, fontWeight:500 }}>{s.label}</div>
          </div>
        ))}
      </div>
    </section>
...
function HowItWorksSection() {
  const { ref, inView } = useInView();
  return (
    <section id="how-it-works" ref={ref} style={{ padding:"100px 40px", background:"#f8fafc" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:64, opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(24px)", transition:"all 0.55s ease" }}>
          <div style={{ display:"inline-block", padding:"5px 16px", borderRadius:999, background:"#e1f5ee", fontSize:"0.8125rem", fontWeight:600, color:"#0f6e56", marginBottom:16 }}>Simple Process</div>
          <h2 style={{ fontSize:"clamp(1.75rem,3vw,2.5rem)", fontWeight:800, color:"#0f172a", letterSpacing:"-0.022em", marginBottom:14 }}>Your Seamless Healthcare Journey</h2>
          <p style={{ fontSize:"1.05rem", color:"#475569", maxWidth:480, margin:"0 auto", lineHeight:1.75 }}>Three simple steps to connect with your specialist and manage your health from anywhere.</p>
        </div>
...
function BentoSection() {
  const { ref, inView } = useInView();
  return (
    <section id="specialists" ref={ref} style={{ padding:"100px 40px", background:"white" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>

        {/* Top row */}
        <div className="landing-bento-top">
          {/* AI card */}
          <div style={{ borderRadius:28, background:"linear-gradient(135deg,#0f6e56 0%,#1a9478 100%)", padding:44, color:"white", display:"flex", flexDirection:"column", justifyContent:"space-between", minHeight:260, position:"relative", overflow:"hidden", opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(24px)", transition:"all 0.6s ease" }}>
            ...
            <Link href="/symptom-checker"
              style={{ display:"inline-flex", alignItems:"center", justifyContent:"center", gap:8, padding:"13px 24px", borderRadius:12, background:"rgba(255,255,255,0.88)", color:"#0f6e56", fontWeight:700, fontSize:"0.9375rem", textDecoration:"none", marginTop:24, transition:"background-color 0.2s ease" }}
          ...
          {/* Specialists header */}
          <div style={{ borderRadius:28, background:"#f1f5f9", padding:44, display:"flex", alignItems:"center", justifyContent:"space-between", gap:24, opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(24px)", transition:"all 0.6s 0.1s ease" }}>
            <div>
              <h2 style={{ fontSize:"1.75rem", fontWeight:800, color:"#0f172a", marginBottom:10, lineHeight:1.2 }}>Meet Our Top Specialists</h2>
              <p style={{ fontSize:"0.9375rem", color:"#475569", lineHeight:1.65 }}>World-class medical professionals, just a click away.</p>
            </div>
            <Link href="/doctors"
              style={{ display:"flex", alignItems:"center", gap:6, padding:"10px 20px", borderRadius:12, background:"white", color:"#0f6e56", fontSize:"0.875rem", fontWeight:600, textDecoration:"none", border:"1px solid #e2e8f0", whiteSpace:"nowrap", flexShrink:0, transition:"background-color 0.2s ease" }}
        ...
        <div className="landing-specialists-grid">
          {SPECIALISTS.map((doc, i) => (
            <div key={doc.name}
              style={{ borderRadius:24, background:"#f8fafc", overflow:"hidden", cursor:"pointer", opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(28px)", transition:`opacity 0.6s ease ${(i+2)*0.1}s, transform 0.6s ease ${(i+2)*0.1}s, box-shadow 0.25s ease` }}
              onMouseEnter={e=>{(e.currentTarget as HTMLDivElement).style.transform="translateY(-6px)";(e.currentTarget as HTMLDivElement).style.boxShadow="0 18px 48px rgba(0,0,0,0.1)";}}
              ...
              <div style={{ padding:22 }}>
                <div style={{ fontWeight:700, fontSize:"1rem", color:"#0f172a", marginBottom:4 }}>{doc.name}</div>
                <div style={{ fontSize:"0.8125rem", color:"#94a3b8", marginBottom:14 }}>{doc.specialty}</div>
                <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                  <span style={{ color:"#f59e0b", fontSize:"1rem" }}>★</span>
                  <span style={{ fontSize:"0.875rem", fontWeight:700, color:"#0f172a" }}>{doc.rating}</span>
                  <span style={{ fontSize:"0.8125rem", color:"#94a3b8" }}>({doc.reviews}+ reviews)</span>
                </div>
              </div>
            </div>
          ))}
...
function CTASection() {
  const { ref, inView } = useInView();
  return (
    <section ref={ref} style={{ padding:"80px 40px", background:"linear-gradient(135deg,#0f6e56 0%,#1a9478 100%)" }}>
      <div style={{ maxWidth:720, margin:"0 auto", textAlign:"center", opacity:inView?1:0, transform:inView?"translateY(0)":"translateY(24px)", transition:"all 0.6s ease" }}>
        ...
        <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
          <Link href="/register/patient"
            style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"14px 32px", borderRadius:12, background:"white", color:"#0f6e56", fontSize:"1rem", fontWeight:700, textDecoration:"none", boxShadow:"0 8px 24px rgba(0,0,0,0.15)", transition:"transform 0.2s ease,box-shadow 0.2s ease" }}
    ...
    <footer style={{ background:"#0f172a", color:"white", padding:"64px 40px 36px" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div className="landing-footer-grid" style={{ marginBottom:48 }}>
          {/* Brand column */}
          <div>
            <div style={{ fontFamily:"ui-monospace,monospace", fontSize:"1.3rem", fontWeight:700, marginBottom:16 }}>
        ...
        <div style={{ borderTop:"1px solid rgba(255,255,255,0.08)", paddingTop:24, display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
          <p style={{ fontSize:"0.8125rem", color:"rgba(255,255,255,0.3)" }}>© 2024 ezClinic Digital Sanctuary. All rights reserved.</p>
  ...
  if (isLoading) {
    return (
      <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#f8fafc" }}>
        <div style={{ width:36, height:36, borderRadius:"50%", border:"3px solid #e2e8f0", borderTopColor:"#0f6e56", animation:"spin 0.7s linear infinite" }} />
